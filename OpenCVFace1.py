...
# several positive and negative samples to train the model (viola-jones algo.)
...
detected_faces = cascade_classifier.detectMultiScale(gray_image, scaleFactor=1.1, miniNeighbours=10, minSize=(30, 30))
